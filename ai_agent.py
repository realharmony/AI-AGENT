...
Original file is located at
    https://colab.research.google.com/drive/1J9ASyVM28BrJD2xSPzljZVYGSQQ8Rnud
"""
...
"""### 4. `requirements.txt` file for deployment

When deploying your Streamlit app (e.g., to Streamlit Community Cloud), you'll need a `requirements.txt` file in the root of your repository. This file tells the deployment environment which Python packages to install. Based on our code, it should look like this:
"""
